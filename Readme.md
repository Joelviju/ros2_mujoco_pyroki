...
#Fore the actual codes in the repository refer to codes refer to src/mujoco_cpp_pkg/src/ur10e_moveit_robot1.cpp for a simple moveit api code and the important code src/mujoco_cpp_pkg/src/mujoco_follow_joint_trajectory.cpp 
